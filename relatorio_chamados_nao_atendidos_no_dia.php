...
<hr/>
<h2>Relatório de Chamados não atendidos no dia</h2> - <div id="qt_registros"> </div>
<div id="dvData">
    <table bordercolor="" width="100%" id="tblExport" style="border:1px solid black; ">
        ...
        if (isset($_POST['enviar']) && $_POST['enviar']) {
            ...
            $rs = $relatorio_acompanhamento->buscarChamadosNaoAtendidosNoDiaPorPeriodo ($_POST['dt_inicio'], $_POST['dt_fim']);
...
<script type="text/javascript" language="javascript" class="init">
    $(document).ready(function () {
        ...
        $("#btnExportCSV").click(function (e) {
            exportTableToCSV.apply(this, [$('#dvData>table'), 'relatorio_chamados_nao_atendidos_no_dia_' + getDataAtualParaNomearArquivo() + '.csv', 'csv']);
        });
        ...
        $("#btnExportXLS").click(function () {
            $("#tblExport").btechco_excelexport({
                ...
                , filename: 'relatorio_chamados_nao_atendidos_no_dia_' + getDataAtualParaNomearArquivo()
            });
        });
