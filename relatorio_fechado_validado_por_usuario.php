...
<hr/>
<h2>Relatório da Quantidade de Chamados Fechados Validados pelo usuario</h2> - <div id="qt_registros"> </div>
<div id="dvData">
    <table bordercolor="" width="100%" id="tblExport" style="border:1px solid black; ">
        ...
        if (isset($_POST['enviar']) && $_POST['enviar']) {
            ...
            $rs = $relatorio_acompanhamento->buscarChamadosSatisfacaoBonsEOtimosPorPeriodo($_POST['dt_inicio'], $_POST['dt_fim']);
            ...
            if($rs){
                ...
                foreach ($rs as $resultado) {
                    ...
                    echo "<td align='left'>$resultado->resposta_pesquisa</td>";
...
<script type="text/javascript" language="javascript" class="init">
    $(document).ready(function () {
        ...
        $("#btnExportCSV").click(function (e) {
            exportTableToCSV.apply(this, [$('#dvData>table'), 'relatorio_fechado_validado_por_usuario_' + getDataAtualParaNomearArquivo() + '.csv', 'csv']);
        });
        ...
        $("#btnExportXLS").click(function () {
            $("#tblExport").btechco_excelexport({
                ...
                , filename: 'relatorio_fechado_validado_por_usuario_' + getDataAtualParaNomearArquivo()
            });
        });
