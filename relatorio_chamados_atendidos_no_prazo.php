...
<div id="dvData">
    <table bordercolor="" width="100%" id="tblExport" style="border:1px solid black; ">
        ...
        if (isset($_POST['enviar']) && $_POST['enviar']) {
            ...
            $rs = $relatorio_acompanhamento->buscarChamadosAtendidosDentroDoPrazoPorPeriodo($_POST['dt_inicio'], $_POST['dt_fim']);
...
<script type="text/javascript" language="javascript" class="init">
    $(document).ready(function () {
        ...
        $("#btnExportCSV").click(function (e) {
            exportTableToCSV.apply(this, [$('#dvData>table'), 'relatorio_chamados_atendidos_no_prazo_' + getDataAtualParaNomearArquivo() + '.csv', 'csv']);
        });
        ...
        $("#btnExportXLS").click(function () {
            $("#tblExport").btechco_excelexport({
                ...
                , filename: 'relatorio_chamados_atendidos_no_prazo_' + getDataAtualParaNomearArquivo()
            });
        });
