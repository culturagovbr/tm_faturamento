...
<hr/>
<h2>Relatório de Chamados Tratados com Sucesso</h2>
<div id="dvData">
    <table bordercolor="" width="100%" id="tblExport" style="border:1px solid black; ">
        <!--<thead>-->
        <div id="qt_registros"> <b></b></div>
        <tr class="titulo">
            <td>Nº Ticket</td>
            <td>Usuário</td>
            <td>Setor</td>
        ...
        if (isset($_POST['enviar']) && $_POST['enviar']) {
            ...
            $rs = $relatorio_acompanhamento->buscarChamadosAtendidosPorStatusSLAPorPeriodo($_POST['dt_inicio'], $_POST['dt_fim']);
            if($rs){
                $cont = 0;
                foreach($rs as $indice => $linha) {
                    #echo "<tr><td bgcolor='#b9F9a9' colspan='10'><h2>$indice</h2></td></tr>";
                    $qnt_resgistros = count($linha);
    ...
    $(document).ready(function () {
        ...
        $("#btnExportXLS").click(function () {
            $("#tblExport").btechco_excelexport({
                ...
                , filename: 'acompanhamento_das_atividades_agrupado_' + getDataAtualParaNomearArquivo()
            });
        });
